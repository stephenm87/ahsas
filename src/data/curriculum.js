  ...
  units: [
    ...
    },
    {
      ...
      keyEvents: [
        ...
        { date: -221, title: 'Qin Unification & Legalist State', pieces: ['political', 'cultural'], description: 'Qin Shi Huang unified China under Legalist principles: standardized weights, measures, writing, and ruthlessly suppressed dissent.', sourceUrl: 'https://www.britannica.com/place/China/The-Qin-empire-221-207-bce' },
    ...
    },
    {
      ...
      keyEvents: [
        { date: 618, title: 'Tang Dynasty Founded', pieces: ['political'], description: 'Li Yuan (Emperor Gaozu) overthrew the Sui dynasty and established the Tang, which would become one of China\'s most glorious periods.', sourceUrl: 'https://www.britannica.com/place/China/The-Tang-dynasty' },
        { date: 626, title: 'Emperor Taizong Takes Power', pieces: ['political', 'cultural'], description: 'Li Shimin became one of China\'s greatest emperors, expanding the empire, reforming government, and promoting cultural flourishing.', sourceUrl: 'https://www.britannica.com/biography/Taizong-emperor-of-Tang-dynasty' },
        { date: 690, title: 'Empress Wu Zetian Rules', pieces: ['political', 'social'], description: 'The only woman to officially rule as emperor of China, she expanded the merit-based civil service exams and patronized Buddhism.', sourceUrl: 'https://www.britannica.com/biography/Wuhou' },
        ...
        { date: 751, title: 'Battle of Talas', pieces: ['political', 'innovation'], description: 'Arab-Tang clash in Central Asia; Chinese papermakers captured, leading to the spread of papermaking technology westward.', sourceUrl: 'https://www.britannica.com/place/China/The-Tang-dynasty' },
        { date: 755, title: 'An Lushan Rebellion', pieces: ['political', 'social'], description: 'Devastating eight-year rebellion that killed ~36 million people (two-thirds of the empire\'s population), permanently weakening the Tang.', sourceUrl: 'https://www.britannica.com/biography/An-Lushan' },
        ...
        { date: 907, title: 'Fall of the Tang Dynasty', pieces: ['political'], description: 'Internal rebellions, eunuch power, and regional warlords led to the dynasty\'s collapse, ushering in the Five Dynasties period.', sourceUrl: 'https://www.britannica.com/place/China/The-Tang-dynasty' }
      ],
    ...
    },
    {
      ...
      keyEvents: [
        ...
        { date: 1382, title: 'Hongwu Reforms', pieces: ['political', 'economic'], description: 'Emperor Hongwu rebuilt the agricultural economy, reformed land taxes, established the lijia system, and centralized imperial power.', sourceUrl: 'https://www.britannica.com/biography/Hongwu' },
        ...
        { date: 1421, title: 'Capital Moved to Beijing', pieces: ['political'], description: 'Emperor Yongle moved the capital from Nanjing to Beijing and built the Forbidden City, shifting power northward.', sourceUrl: 'https://www.britannica.com/topic/Forbidden-City' },
        ...
        { date: 1449, title: 'Tumu Crisis', pieces: ['political'], description: 'The Zhengtong Emperor was captured by Mongol Oirats, exposing Ming military weakness and triggering defensive reorientation.', sourceUrl: 'https://www.britannica.com/biography/Zhengtong' },
        { date: 1557, title: 'Portuguese at Macau', pieces: ['economic', 'cultural'], description: 'Portugal established a trading post at Macau, beginning direct European-Chinese maritime trade.', sourceUrl: 'https://www.britannica.com/place/Macau-China' },
        { date: 1592, title: 'Wanli Emperor vs. Japan', pieces: ['political'], description: 'Ming China intervened in Korea against Toyotomi Hideyoshi\'s Japanese invasion, draining the treasury and weakening the dynasty.', sourceUrl: 'https://www.britannica.com/biography/Toyotomi-Hideyoshi' },
        { date: 1644, title: 'Fall of the Ming', pieces: ['political', 'social'], description: 'Li Zicheng\'s rebellion captured Beijing; the last Ming emperor hanged himself. The Manchu Qing dynasty swept in from the north.', sourceUrl: 'https://www.britannica.com/place/China/Fall-of-the-Ming-dynasty' }
      ],
    ...
    },
    {
      ...
      keyEvents: [
        ...
        { date: 1275, title: 'Marco Polo Visits China', pieces: ['cultural', 'economic'], description: 'The Venetian traveler documented Yuan China\'s wealth, size, and sophistication, astonishing European readers.', sourceUrl: 'https://www.britannica.com/biography/Marco-Polo' },
        { date: 1279, title: 'Song Dynasty Falls to Mongols', pieces: ['political'], description: 'The final Southern Song resistance collapsed at the Battle of Yamen, completing Mongol conquest of China.', sourceUrl: 'https://www.britannica.com/place/China/The-end-of-Mongol-rule' },
        { date: 1351, title: 'Red Turban Rebellion', pieces: ['political', 'social'], description: 'Han Chinese peasant revolts erupted against Yuan rule, driven by flooding, plague, and resentment of Mongol privilege.', sourceUrl: 'https://www.britannica.com/topic/Red-Turbans' },
        { date: 1644, title: 'Qing Dynasty Established', pieces: ['political'], description: 'The Manchu Qing entered Beijing, beginning the last imperial dynasty. They would rule for 268 years.', sourceUrl: 'https://www.britannica.com/place/China/The-Qing-dynasty' },
        { date: 1661, title: 'Kangxi Emperor Begins Reign', pieces: ['political', 'cultural'], description: 'Kangxi ruled for 61 years (longest in Chinese history), consolidating Qing power, patronizing Chinese culture, and expanding the empire.', sourceUrl: 'https://www.britannica.com/biography/Kangxi' },
        { date: 1735, title: 'Qianlong Emperor Begins Reign', pieces: ['political', 'economic'], description: 'Qianlong presided over the Qing\'s golden age and greatest territorial extent, but his later years saw corruption and decline.', sourceUrl: 'https://www.britannica.com/biography/Qianlong' },
    ...
    },
    {
      ...
      keyEvents: [
        ...
        { date: 1850, title: 'Taiping Rebellion Begins', pieces: ['social', 'political'], description: 'Hong Xiuquan led a massive Christian-inspired rebellion that controlled much of southern China and killed 20–30 million people.', sourceUrl: 'https://www.britannica.com/event/Taiping-Rebellion' },
        ...
        { date: 1898, title: 'Hundred Days Reform', pieces: ['political', 'innovation'], description: 'Emperor Guangxu attempted radical modernization reforms, but Empress Dowager Cixi staged a coup and placed him under house arrest.', sourceUrl: 'https://www.britannica.com/event/Hundred-Days-of-Reform' },
        ...
        { date: 1911, title: 'Wuchang Uprising', pieces: ['political'], description: 'Military mutiny in Wuchang triggered a chain reaction; provinces declared independence from Qing rule.', sourceUrl: 'https://www.britannica.com/place/China/The-end-of-imperial-China' },
        { date: 1912, title: 'Abdication of Puyi', pieces: ['political'], description: 'The child emperor Puyi abdicated on February 12, ending 2,000+ years of imperial rule in China.', sourceUrl: 'https://www.britannica.com/place/China/The-revolution-of-1911' }
      ],
    ...
    },
    {
      ...
      keyEvents: [
        { date: 1912, title: 'Republic of China Proclaimed', pieces: ['political'], description: 'Sun Yat-sen briefly served as provisional president before yielding to Yuan Shikai, who commanded military power.', sourceUrl: 'https://www.britannica.com/biography/Sun-Yat-sen' },
        { date: 1915, title: 'Yuan Shikai Declares Himself Emperor', pieces: ['political'], description: 'Yuan\'s attempt to restore monarchy triggered rebellion and international condemnation; he died in 1916, leaving a power vacuum.', sourceUrl: 'https://www.britannica.com/biography/Yuan-Shikai' },
        { date: 1916, title: 'Warlord Era Begins', pieces: ['political', 'social'], description: 'China fragmented into competing military fiefdoms, each controlled by a regional strongman with private armies.', sourceUrl: 'https://www.britannica.com/place/China/The-warlord-era-1916-28' },
        ...
        { date: 1921, title: 'Chinese Communist Party Founded', pieces: ['political'], description: 'Mao Zedong and 12 other delegates established the CCP in Shanghai, initially with Comintern support.', sourceUrl: 'https://www.britannica.com/topic/Chinese-Communist-Party' },
        { date: 1923, title: 'First United Front', pieces: ['political'], description: 'The GMD (Nationalists) and CCP formed an alliance against warlords, with Soviet advisors reorganizing both parties.', sourceUrl: 'https://www.britannica.com/place/China/The-first-united-front' },
        { date: 1925, title: 'Sun Yat-sen Dies', pieces: ['political'], description: 'The father of the Republic died, leaving a leadership vacuum. Chiang Kai-shek emerged as his successor in the GMD.', sourceUrl: 'https://www.britannica.com/biography/Sun-Yat-sen' },
        { date: 1926, title: 'Northern Expedition Begins', pieces: ['political'], description: 'GMD-CCP forces under Chiang Kai-shek marched north to defeat warlords and reunify China.', sourceUrl: 'https://www.britannica.com/event/Northern-Expedition' },
        { date: 1927, title: 'Shanghai Massacre', pieces: ['political', 'social'], description: 'Chiang Kai-shek violently purged communists and labor unionists in Shanghai, shattering the First United Front.', sourceUrl: 'https://www.britannica.com/place/China/The-interregnum-1912-28' },
        { date: 1928, title: 'Nominal Reunification', pieces: ['political'], description: 'The Northern Expedition captured Beijing; China was nominally reunified under the GMD, though warlords persisted.', sourceUrl: 'https://www.britannica.com/event/Northern-Expedition' }
      ],
    ...
    },
    {
      ...
      keyEvents: [
        { date: 1927, title: 'Civil War Begins', pieces: ['political'], description: 'After the Shanghai Massacre, the CCP retreated to rural areas and began building peasant-based soviets.', sourceUrl: 'https://www.britannica.com/event/Chinese-Civil-War' },
        { date: 1931, title: 'Jiangxi Soviet Established', pieces: ['political', 'social'], description: 'Mao established a rural communist base in Jiangxi province, implementing land reform and guerrilla warfare tactics.', sourceUrl: 'https://www.britannica.com/topic/Jiangxi-Soviet' },
        ...
        { date: 1936, title: 'Xi\'an Incident', pieces: ['political'], description: 'Chiang Kai-shek was kidnapped by Zhang Xueliang and forced to agree to a Second United Front against Japan.', sourceUrl: 'https://www.britannica.com/event/Xian-Incident' },
        { date: 1937, title: 'Second Sino-Japanese War', pieces: ['political'], description: 'Full-scale Japanese invasion of China; Nanjing Massacre (300,000+ killed), forcing GMD to retreat to Chongqing.', sourceUrl: 'https://www.britannica.com/event/Nanjing-Massacre' },
        { date: 1945, title: 'Japan Surrenders', pieces: ['political'], description: 'WWII ended but civil war resumed immediately as GMD and CCP raced to control Japanese-occupied territories.', sourceUrl: 'https://www.britannica.com/event/World-War-II/Japans-surrender' },
        { date: 1946, title: 'Full Civil War Resumes', pieces: ['political', 'economic'], description: 'US mediation failed; the GMD held cities but suffered hyperinflation and corruption while the CCP mobilized rural support.', sourceUrl: 'https://www.britannica.com/event/Chinese-Civil-War' },
        { date: 1948, title: 'Three Great Campaigns', pieces: ['political'], description: 'The CCP won decisive battles at Liaoshen, Huaihai, and Pingjin, destroying the GMD\'s best armies.', sourceUrl: 'https://www.britannica.com/event/Chinese-Civil-War' },
        { date: 1949, title: 'People\'s Republic of China Founded', pieces: ['political'], description: 'On October 1, Mao proclaimed the PRC from Tiananmen. The GMD retreated to Taiwan with the Republic of China government.', sourceUrl: 'https://www.britannica.com/place/China/Establishment-of-the-Peoples-Republic' }
      ],
    ...
    },
    {
      ...
      keyEvents: [
        { date: 1950, title: 'Land Reform Campaign', pieces: ['social', 'economic'], description: 'Mass redistribution of land from landlords to peasants; estimated 1–2 million landlords killed in class struggle meetings.', sourceUrl: 'https://www.britannica.com/place/China/The-Great-Leap-Forward' },
        { date: 1950, title: 'Korean War Intervention', pieces: ['political'], description: 'China entered the Korean War against UN forces, suffering ~180,000 casualties but establishing PRC as a military power.', sourceUrl: 'https://www.britannica.com/event/Korean-War' },
        { date: 1953, title: 'First Five-Year Plan', pieces: ['economic', 'innovation'], description: 'Soviet-style industrialization focusing on heavy industry; significant urban growth but agricultural neglect.', sourceUrl: 'https://www.britannica.com/place/China/The-First-Five-Year-Plan-1953-57' },
        ...
        { date: 1958, title: 'Great Leap Forward', pieces: ['economic', 'social'], description: 'Mao\'s campaign to rapidly collectivize agriculture and industrialize through people\'s communes caused the Great Chinese Famine (1959–1961), killing 15–55 million people.', sourceUrl: 'https://www.britannica.com/event/Great-Leap-Forward' },
        { date: 1960, title: 'Sino-Soviet Split', pieces: ['political'], description: 'Ideological and geopolitical rivalry led to a complete break between China and the Soviet Union.', sourceUrl: 'https://www.britannica.com/event/Sino-Soviet-dispute' },
        ...
        { date: 1969, title: 'Sino-Soviet Border Clashes', pieces: ['political'], description: 'Armed confrontations on Zhenbao Island brought China and the USSR to the brink of nuclear war.', sourceUrl: 'https://www.britannica.com/event/Sino-Soviet-dispute' },
        { date: 1971, title: 'Lin Biao Incident', pieces: ['political'], description: 'Mao\'s chosen successor allegedly plotted a coup and died in a mysterious plane crash fleeing to the Soviet Union.', sourceUrl: 'https://www.britannica.com/biography/Lin-Biao' },
        { date: 1972, title: 'Nixon Visits China', pieces: ['political'], description: 'US President Nixon\'s visit to Beijing marked a dramatic Cold War realignment, opening US-China relations.', sourceUrl: 'https://www.britannica.com/biography/Richard-Nixon/Foreign-affairs' },
        { date: 1976, title: 'Death of Mao Zedong', pieces: ['political'], description: 'Mao died on September 9. The Gang of Four was arrested within a month, ending the Cultural Revolution era.', sourceUrl: 'https://www.britannica.com/biography/Mao-Zedong' }
      ],
